...
PARAM_WSEN_T 	Param_WSen[PARAM_MAX] = {
	...
	/*6*/{120, 250, 70, 100, 250, 110,   0, 100, 100, 280, 50, 507, 406, 60.0, 0.001, 0.01 },
	/*7*/{120, 250, 70, 100, 250, 110,   0, 100, 100, 280, 50, 507, 406, 60.0, 0.0, 0.001 },
	/*8*/{120, 250, 70, 100, 250, 110,   0, 100, 100, 280, 50, 507, 406, 60.0, 0.0, 0.001 },
...
PARAM_SLALOM_T 		Param_S90[PARAM_MAX] = {
	    // °,  r, in,out,   v, Kp,  Ki,  Kd
	/*1*/{90, 50, 15, 15, 600, 1.5, 0.0006, 0.0004},
	/*2*/{90, 50, 25, 12, 700, 2.5, 0.06, 0.004},
	/*3*/{90, 60, 10,  8, 800, 2.5, 0.06, 0.004},
	/*4*/{90, 60, 10,  8, 800, 2.5, 0.06, 0.004},
	/*5*/{90, 60, 8, 18,1000, 2.0, 0.06, 0.004},
	/*6*/{90, 60, 8, 18,1000, 2.0, 0.06, 0.004},
	/*7*/{90, 60, 8, 18,1000, 2.0, 0.06, 0.004},
	/*8*/{90, 60, 8, 18,1000, 2.0, 0.06, 0.004},
	/*9*/{87, 60, 3, 15,1200, 0.5, 0.06, 0.004}
...
PARAM_SLALOM_T 		Global_S180 = {
	// Angle, Radius, In, Out, Speed, Kp, Ki, Kd
		180, 80, 45, 65, 1200, 2.5, 0.06, 0.004
};
...
PARAM_SLALOM_T 		Global_W90 = {
	// Angle, Radius, In, Out, Speed, Kp, Ki, Kd
		90, 100, 40, 60, 1300, 2.5, 0.06, 0.004
};
//===============================================
// パラメータ : ロード
//===============================================
