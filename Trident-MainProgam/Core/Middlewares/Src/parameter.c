...
PARAM_WSEN_T 	Param_WSen[PARAM_MAX] = {
	...
	/*1*/{180, 240, 50, 100, 250, 110,   0, 100, 110, 260, 70, 935, 580, 10.0, 0.0, 0.000 },
	/*2*/{120, 250, 85, 100, 250, 110,   0, 120, 100, 280, 70, 402, 504, 40.0, 0.0, 0.000 },
	/*3*/{120, 280, 85, 100, 250, 110,   0, 120, 100, 280, 70, 463, 389, 40.0, 0.0, 0.001 },
	/*4*/{120, 250, 70, 100, 250, 110,   0, 110, 100, 280, 70, 463, 389, 40.0, 0.0, 0.001 },
	/*5*/{120, 250, 70, 100, 250, 115,   0, 110, 108, 280, 70, 507, 406, 90.0, 0.0, 0.001 },
	/*6*/{120, 250, 70, 100, 250, 110,   0, 110, 108, 280, 70, 507, 406, 90.0, 0.001, 0.01 },
	/*7*/{120, 250, 70, 100, 250, 110,   0, 118, 118, 310, 70, 507, 406, 120.0, 0.0, 0.001 },
	/*8*/{120, 250, 70, 100, 250, 110,   0, 118, 108, 300, 70, 507, 406, 180.0, 0.0, 0.001 },
	/*9*/{120, 250, 70, 100, 250, 110,   0, 100, 100, 280, 70, 507, 406, 60.0, 0.0, 0.001 }
...
PARAM_STRAIGHT_T	Param_Straight[PARAM_MAX] = {
	...
	/*1*/{170,  90, 145,  57, -90,  600, 1200, 1500, 300,  10, 20,  5.0, 0.1, 0.001 },
	...
	/*7*/{180,  90, 145,  57, -90, 1000, 1600, 4000, 200,  5, 10,  5.5, 0.1, 0.001 },
	/*8*/{180,  90, 145,  57, -90, 1000, 2500, 4000, 200,  5, 10,  5.5, 0.1, 0.001 },
	/*9*/{180,  90, 145,  57, -90, 1200, 1800, 4000, 200,  8,  10,  5.5, 0.1, 0.001 }
};

PARAM_SLALOM_T 		Param_S90[PARAM_MAX] = {
	    // °,  r, in,out,   v, Kp,  Ki,  Kd
	/*1*/{90, 50, 20, 10, 600, 1.5, 0.0006, 0.0004},
	/*2*/{90, 50, 25, 12, 700, 2.5, 0.06, 0.004},
	/*3*/{90, 60, 10,  8, 800, 2.5, 0.06, 0.004},
	/*4*/{90, 60, 10,  8, 800, 2.5, 0.06, 0.004},
	/*5*/{90, 60, 1, 27,1000, 2.5, 0.06, 0.004},
	/*6*/{90, 60, 1, 27,1000, 2.5, 0.06, 0.004},
	/*7*/{90, 60, 1, 30,1000, 2.5, 0.06, 0.004},
	/*8*/{92, 60, 2, 30,1000, 2.8, 0.06, 0.004},
	/*9*/{80, 60, 2, 25,1200, 2.0, 0.06, 0.004}
//	    // °,  r, in,out,   v, Kp,  Ki,  Kd
