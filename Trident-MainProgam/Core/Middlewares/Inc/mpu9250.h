...
//                             			K.Richardo
//################################################
#ifndef MIDDLEWARES_MPU9250_H_
#define MIDDLEWARES_MPU9250_H_
...
// Define宣言
//************************************************
#define IMU_DELTA_T			(0.001f)		// 制御周期 : 1 ms
#define IMU_SAMPLING		256				// サンプリング数
#define IMU_DRIFT_SAMPLING 	1000			// ドリフトサンプリング時間[ms]
